...
- _Partie locale_ : partie à gauche du _@_ de l'adresse email (par exemple, si vous voulez créer `contact@example.org`, la partie locale sera `contact`). Vous pouvez aussi créer une [adresse collectrice (catch-all)](e-mails/catch-all).
