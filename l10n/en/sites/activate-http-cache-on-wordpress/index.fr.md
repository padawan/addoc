...
- une fois sur la page d’accueil du WordPress, ouvrez le panel développeur de votre navigateur, menu _Réseau_/_Network_. Effectuez une recherche sur l'en-tête `Age`.
