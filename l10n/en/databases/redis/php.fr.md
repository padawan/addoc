+++
url = "/en/data-bases/redis/php/"
title = "How to configure a PHP application with Redis"
hidden = true
layout = "howto"
tags = [ "database", "Redis", "php" ]
+++

## Setup

Using Redis in PHP requires [installing a PECL extension](languages/php/extensions#depuis-peclhttpspeclphpnet) on your account via [SSH](remote-access/ssh).
